...
public class ArtillerySupport extends ArmorAbility {
    ...
    @Override
    public int icon() {
        return HeroIcon.ATILLERYSUPPORT;
    }

    @Override
    public Talent[] talents() {
        return new Talent[]{Talent.ARTILLERY_1, Talent.ARTILLERY_2, Talent.ARTILLERY_3, Talent.HEROIC_ENERGY};
    }
}
