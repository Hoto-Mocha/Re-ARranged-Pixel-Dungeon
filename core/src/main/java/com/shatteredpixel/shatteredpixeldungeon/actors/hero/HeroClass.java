...
public enum HeroClass {
	...
	private static void initWarrior( Hero hero ) {
		...
		//new CursedSword().identify().collect();
		...
		//new ElixirOfIcyTouch().collect();
		//new ElixirOfToxicEssence().collect();
		//new ShockingBrew().collect();
		...
		//new MetalShard().quantity(50).collect();
		//new ArcaneResin().quantity(50).collect();
		//new LiquidMetal().quantity(800).collect();
