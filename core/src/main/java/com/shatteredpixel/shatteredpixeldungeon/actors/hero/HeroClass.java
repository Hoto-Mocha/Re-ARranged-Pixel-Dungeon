...
public enum HeroClass {
	...
	private static void initWarrior( Hero hero ) {
		...
		//ew Teleporter().collect();
		//ew TestWeapon().identify().collect();
		//ew PotionOfHealing().quantity(100).collect();
		//ew PlateArmor().identify().upgrade(100).collect();
		//ew RingOfMight().identify().upgrade(100).collect();
		//ew RingOfAccuracy().identify().upgrade(100).collect();
		//ew Longsword().identify().upgrade(10).collect();
		//ew PotionOfMagicalSight().identify().quantity(100).collect();
		//ew HandyBarricade().quantity(100).collect();
		//ew PotionOfExperience().identify().quantity(29).collect();
