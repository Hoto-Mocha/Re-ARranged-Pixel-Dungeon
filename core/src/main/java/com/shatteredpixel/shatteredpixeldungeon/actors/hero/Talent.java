...
public enum Talent {
	...
	//Fighter T3
	SWIFT_MOVEMENT(148, 3), JAW_STRIKE(149, 3), RING_KNUCKLE(150, 3), SINGULAR_STRIKE(151, 3), QUICK_STEP(152, 3), COUNTER_ATTACK(153, 3),
	//Spectral Blades T4
	...
	//Researcher T3
	SHOCK_DRAIN(271, 3), DEW_MAKING(272, 3), BIO_ENERGY(273, 3), CLINICAL_TRIAL(274, 3), BIOLOGY_PROJECT(275, 3), CHEMICAL(276, 3),
	//Sprout T4
	...
	public static void initSubclassTalents( HeroSubClass cls, ArrayList<LinkedHashMap<Talent, Integer>> talents ){
		...
		switch (cls){
			...
			case WARDEN:
				...
				break;
			case FIGHTER:
				Collections.addAll(tierTalents, ATK_SPEED_ENHANCE, ACC_ENHANCE, EVA_ENHANCE, BETTER_CHOICE, SWIFT_MOVEMENT, JAW_STRIKE, RING_KNUCKLE, SINGULAR_STRIKE, QUICK_STEP, COUNTER_ATTACK);
				break;
			case LAUNCHER:
			...
			case ADVENTURER:
				...
				break;
			case RESEARCHER:
				Collections.addAll(tierTalents, ATK_SPEED_ENHANCE, ACC_ENHANCE, EVA_ENHANCE, BETTER_CHOICE, SHOCK_DRAIN, DEW_MAKING, BIO_ENERGY, CLINICAL_TRIAL, BIOLOGY_PROJECT, CHEMICAL);
				break;
			case WEAPONMASTER:
