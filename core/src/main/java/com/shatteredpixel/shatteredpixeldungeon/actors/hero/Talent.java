...
public enum Talent {
	...
	//Fighter T3
	SWIFT_MOVEMENT(115, 3), BONE_CRUSHER(116, 3), RING_KNUCKLE(117, 3),
	//Spectral Blades T4
	...
	public static void initSubclassTalents( HeroSubClass cls, ArrayList<LinkedHashMap<Talent, Integer>> talents ){
		...
		switch (cls){
			...
			case WARDEN:
				...
				break;
			case FIGHTER:
				Collections.addAll(tierTalents, BETTER_CHOICE, SWIFT_MOVEMENT, BONE_CRUSHER, RING_KNUCKLE, ATK_SPEED_ENHANCE, DEF_ENHANCE, ACC_ENHANCE, EVA_ENHANCE, DEW_ENHANCE);
				break;
			case LAUNCHER:
