...
public enum Talent {
	...
	//Veteran T3
	ARM_VETERAN(17, 3), MARTIAL_ARTS(18, 3), ENHANCED_FOCUSING(19, 3),
	//Heroic Leap T4
	BODY_SLAM(20, 4), IMPACT_WAVE(21, 4), DOUBLE_JUMP(22, 4),
	//Shockwave T4
	EXPANDING_WAVE(23, 4), STRIKING_WAVE(24, 4), SHOCK_FORCE(25, 4),
	//Endure T4
	SUSTAINED_RETRIBUTION(26, 4), SHRUG_IT_OFF(27, 4), EVEN_THE_ODDS(28, 4),
	...
	//engineer T3
	AMMO_PRESERVE(49, 3), CONNECTING_CHARGER(50, 3), FASTER_CHARGER(51, 3),
	//Elemental Blast T4
	BLAST_RADIUS(52, 4), ELEMENTAL_POWER(53, 4), REACTIVE_BARRIER(54, 4),
	//Wild Magic T4
	WILD_POWER(55, 4), FIRE_EVERYTHING(56, 4), CONSERVED_MAGIC(57, 4),
	//Warp Beacon T4
	TELEFRAG(58, 4), REMOTE_BEACON(59, 4), LONGRANGE_WARP(60, 4),
	...
	//Chaser T3
	INCISIVE_BLADE(81, 3), LETHAL_SURPRISE(82, 3), CHAIN_CLOCK(83, 3),
	//Smoke Bomb T4
	HASTY_RETREAT(84, 4), BODY_REPLACEMENT(85, 4), SHADOW_STEP(86, 4),
	//Death Mark T4
	FEAR_THE_REAPER(87, 4), DEATHLY_DURABILITY(88, 4), DOUBLE_MARK(89, 4),
	//Shadow Clone T4
	SHADOW_BLADE(90, 4), CLONED_ARMOR(91, 4), PERFECT_COPY(92, 4),
	...
	//Fighter T3
	SKILLS_PRACTICE(113, 3), MIND_PRACTICE(114, 3), VITAL_ATTACK(115, 3),
	//Spectral Blades T4
	FAN_OF_BLADES(116, 4), PROJECTING_BLADES(117, 4), SPIRIT_BLADES(118, 4),
	//Natures Power T4
	GROWING_POWER(119, 4), NATURES_WRATH(120, 4), WILD_MOMENTUM(121, 4),
	//Spirit Hawk T4
	EAGLE_EYE(122, 4), GO_FOR_THE_EYES(123, 4), SWIFT_SPIRIT(124, 4),

	//Gunner T1
	REARRANGE(128), GUNNERS_INTUITION(129), SPEEDY_MOVE(130), SAFE_RELOAD(131),
	//Gunner T2
	IN_THE_GUNFIRE(132), ANOTHER_CHANCE(133), BULLET_FOCUS(134), CAMOUFLAGE(135), LARGER_MAGAZINE(136),
	//Gunner T3
	MELEE_ENHANCE(137, 3), HEAVY_ENHANCE(138, 3),
	//Launcher T3
	HEAVY_GUNNER(139, 3), ACC_PRACTICE(140, 3), RECOIL_PRACTICE(141, 3),
	//Ranger T3
	HANDGUN_MASTER(142, 3), RECOIL_CONTROL(143, 3), ELEMENTAL_BULLET(144, 3),
	//RifleMan T3
	RIFLE_MASTER(145, 3), ONLY_ONE_SHOT(146, 3), EVASIVE_MOVE(147, 3),
	//Riot T4
	HASTE_MOVE(148, 4), SHOT_CONCENTRATION(149,4), ROUND_PRESERVE(150, 4),
	//ReinforcedArmor T4
	BAYONET(151, 4), TACTICAL_SIGHT(152, 4), PLATE_ADD(153, 4),
	//FirstAidKit T4
	ADDITIONAL_MEDS(154,4), THERAPEUTIC_BANDAGE(155, 4), FASTER_HEALING(156,4),

	//Samurai T1
	CRITICAL_MEAL(160), MASTERS_INTUITION(161), UNEXPECTED_SLASH(162), FLOW_AWAY(163),
	//Samurai T2
	FOCUSING_MEAL(164), CRITICAL_UPGRADE(165), MAGICAL_TRANSFERENCE(166), PARRY(167), DETECTION(168),
	//Samurai T3
	DEEP_SCAR(169, 3), FAST_LEAD(170, 3),
	//Slasher T3
	CONTINUOUS_ATTACK(171, 3), SLASHING_PRACTICE(172, 3), SERIAL_MOMENTUM(173, 3),
	//Master T3
	DONG_MIND_EYES(174, 3), JUNG_DETECTION(175, 3), MIND_FOCUS(176, 3),
	//Slayer T3
	AFTERIMAGE(177, 3), ENERGY_DRAIN(178, 3), FTL(179, 3),
	//Awake T4
	AWAKE_LIMIT(180, 4), AWAKE_DURATION(181, 4), INSURANCE(182, 4),
	//ShadowBlade T4
	DOUBLE_BLADE_PRACTICE(183, 4), CRITICAL_SHADOW(184, 4),HERBAL_SHADOW(185, 4),
	//Kunai T4
	KUNAI_OF_DOOM(186, 4), MYSTICAL_KUNAI(187, 4), POISONED_KUNAI(188, 4),

	//Planter T1
	FLOWER_BERRY(192), ADVENTURERS_INTUITION(193), SWING(194), NATURES_PROTECTION(195),
	//Planter T2
	NATURAL_MEAL(196), HERBAL_HEALING(197), SPROUT(198), VINE(199), MASS_PRODUCTION(200),
	//Planter T3
	BLOOMING_WEAPON(201, 3), FARMER(202, 3),
	//TreasureHunter T3
	TAKEDOWN(203, 3), DETECTOR(204, 3), GOLD_SHIELD(205, 3),
	//Adventurer T3
	JUNGLE_ADVENTURE(206, 3), SHADOW(207, 3), VINE_WHIP(208, 3),
	//Researcher T3
	SHOCK_DRAIN(209, 3), DEW_MAKING(210, 3), BIO_ENERGY(211, 3),
	//Sprout T4
	JUNGLE(212, 4), FOREST(213, 4), REGROWTH(214, 4),
	//TreasureMap T4
	LONG_LUCK(215, 4), FORESIGHT(216, 4), GOLD_HUNTER(217, 4),
	//Root T4
	POISONOUS_ROOT(218, 4), ROOT_SPREAD(219, 4), ROOT_ARMOR(220, 4),
	//universal T4
	HEROIC_ENERGY(29, 4), //See icon() and title() for special logic for this one
	//Ratmogrify T4
	RATSISTANCE(31, 4), RATLOMACY(63, 4), RATFORCEMENTS(95, 4),

	//universal T2
	ATK_SPEED_ENHANCE(30, 4), DEF_ENHANCE(62, 4), ACC_ENHANCE(94, 4), EVA_ENHANCE(126, 4), DEW_ENHANCE(158, 4),
	//universal T3
	BETTER_CHOICE(159, 3);
	...
	public static void initSubclassTalents( HeroSubClass cls, ArrayList<LinkedHashMap<Talent, Integer>> talents ){
		...
		//tier 2
		Collections.addAll(tierTalents, ATK_SPEED_ENHANCE, DEF_ENHANCE, ACC_ENHANCE, EVA_ENHANCE, DEW_ENHANCE);
		for (Talent talent : tierTalents){
			talents.get(1).put(talent, 0);
		}
		tierTalents.clear();
