...
public enum Talent {
	...
	//Battlemage T3
	EMPOWERED_STRIKE(48, 3), MYSTICAL_CHARGE(49, 3), EXCESS_CHARGE(50, 3), MANA_REPRESENTATION(51, 3),
	//Warlock T3
	...
	//Launcher T3
	HEAVY_GUNNER(153, 3), ACC_PRACTICE(154, 3), RECOIL_PRACTICE(155, 3), EXPLOSIVE_BULLET(156, 3),
	//Ranger T3
	QUICK_RELOAD(157, 3), RECOIL_CONTROL(158, 3), ELEMENTAL_BULLET(159, 3), OUTLAW_OF_BARRENLAND(160, 3),
	//RifleMan T3
	SILENCER(161, 3), ONLY_ONE_SHOT(162, 3), EVASIVE_MOVE(163, 3), ONE_SHOT_ONE_KILL(164, 3),
	//Riot T4
	...
	//Slasher T3
	CONTINUOUS_ATTACK(177, 3), SLASHING_PRACTICE(189, 3), SERIAL_MOMENTUM(190, 3), ARCANE_ATTACK(191, 3),
	//Master T3
	DONG_MIND_EYES(192, 3), DONG_SHEATHING(193, 3), JUNG_DETECTION(194, 3), JUNG_DRAIN(195, 3),
	//Slayer T3
	...
	public static class SingularStrikeTracker extends FlavourBuff{};
	...
	public static void initSubclassTalents( HeroSubClass cls, ArrayList<LinkedHashMap<Talent, Integer>> talents ){
		...
		switch (cls){
			...
			case VETERAN:
				...
				break;
			case BATTLEMAGE:
				Collections.addAll(tierTalents, EMPOWERED_STRIKE, MYSTICAL_CHARGE, EXCESS_CHARGE, MANA_REPRESENTATION, ATK_SPEED_ENHANCE, DEF_ENHANCE, ACC_ENHANCE, EVA_ENHANCE, DEW_ENHANCE, BETTER_CHOICE);
				break;
			case WARLOCK:
			...
			case FIGHTER:
				...
				break;
			case LAUNCHER:
				Collections.addAll(tierTalents, HEAVY_GUNNER, ACC_PRACTICE, RECOIL_PRACTICE, EXPLOSIVE_BULLET, ATK_SPEED_ENHANCE, DEF_ENHANCE, ACC_ENHANCE, EVA_ENHANCE, DEW_ENHANCE, BETTER_CHOICE);
				break;
			case RANGER:
				...
				break;
			case RIFLEMAN:
				Collections.addAll(tierTalents, SILENCER, ONLY_ONE_SHOT, EVASIVE_MOVE, ONE_SHOT_ONE_KILL, ATK_SPEED_ENHANCE, DEF_ENHANCE, ACC_ENHANCE, EVA_ENHANCE, DEW_ENHANCE, BETTER_CHOICE);
				break;
			case SLASHER:
				...
				break;
			case MASTER:
				Collections.addAll(tierTalents, DONG_MIND_EYES, DONG_SHEATHING, JUNG_DETECTION, JUNG_DRAIN, ATK_SPEED_ENHANCE, DEF_ENHANCE, ACC_ENHANCE, EVA_ENHANCE, DEW_ENHANCE, BETTER_CHOICE);
				break;
			case SLAYER:
