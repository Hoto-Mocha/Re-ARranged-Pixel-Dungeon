...
public enum Talent {
	...
	//Fighter T3
	SWIFT_MOVEMENT(148, 3), JAW_STRIKE(149, 3), RING_KNUCKLE(150, 3), MYSTICAL_PUNCH(151, 3), QUICK_STEP(152, 3), COUNTER_ATTACK(153, 3),
	//Spectral Blades T4
	...
	public static void initSubclassTalents( HeroSubClass cls, ArrayList<LinkedHashMap<Talent, Integer>> talents ){
		...
		switch (cls){
			...
			case WARDEN:
				...
				break;
			case FIGHTER:
				Collections.addAll(tierTalents, ATK_SPEED_ENHANCE, ACC_ENHANCE, EVA_ENHANCE, BETTER_CHOICE, SWIFT_MOVEMENT, JAW_STRIKE, RING_KNUCKLE, MYSTICAL_PUNCH, QUICK_STEP, COUNTER_ATTACK);
				break;
			case LAUNCHER:
