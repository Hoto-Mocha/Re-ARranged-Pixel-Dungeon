...
public class RevolverHP extends MeleeWeapon {
    ...
    public String info() {
        ...
        if (levelKnown) {
            ...
            info += "\n\n" + Messages.get(RevolverHP.class, "stats_known",
                    Bulletmin(RevolverHP.this.buffedLvl()),
                    Bulletmax(RevolverHP.this.buffedLvl()),
            ...
            info += "\n\n" + Messages.get(RevolverHP.class, "stats_unknown",
                    Bulletmin(0),
                    Bulletmax(0),
                    round, max_round, new DecimalFormat("#.##").format(reload_time));
        }
    ...
    public RevolverHP.Bullet knockBullet(){
        return new RevolverHP.Bullet();
    }
    public class Bullet extends MissileWeapon {
        ...
        public int buffedLvl(){
            return RevolverHP.this.buffedLvl();
        }
        ...
        public int damageRoll(Char owner) {
            ...
            int bulletdamage = Random.NormalIntRange(Bulletmin(RevolverHP.this.buffedLvl()),
                    Bulletmax(RevolverHP.this.buffedLvl()));
        ...
        public boolean hasEnchant(Class<? extends Enchantment> type, Char owner) {
            return RevolverHP.this.hasEnchant(type, owner);
        }
        ...
        public int proc(Char attacker, Char defender, int damage) {
            ...
            if (RevolverHP.this.enchantment == null
            ...
            } else if (RevolverHP.this.enchantment == null
                    && Random.Int(3) < hero.pointsInTalent(Talent.SHARED_ENCHANTMENT)
                    && hero.buff(MagicImmune.class) == null
                    && bow2 != null
                ...
                return RevolverHP.this.proc(attacker, defender, damage);
            }
        }
        ...
        public float delayFactor(Char user) {
            if (hero.buff(Riot.riotTracker.class) != null) {
                return RevolverHP.this.delayFactor(user)/2f;
            } else {
                return RevolverHP.this.delayFactor(user);
            }
        }
        ...
        @Override
        public int STRReq(int lvl) {
            if (RevolverHP.this.masteryPotionBonus) {
                return STRReq(tier, RevolverHP.this.buffedLvl()) - 2;
            }
            return STRReq(tier, RevolverHP.this.buffedLvl());
        }
