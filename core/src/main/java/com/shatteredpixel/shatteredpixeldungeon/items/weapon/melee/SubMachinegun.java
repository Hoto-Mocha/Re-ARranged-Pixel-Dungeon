...
public class SubMachinegun extends MeleeWeapon {
    ...
    public class Bullet extends MissileWeapon {
        ...
        public int buffedLvl(){
            return SubMachinegun.this.buffedLvl();
        }
        ...
        public int damageRoll(Char owner) {
            ...
            int bulletdamage = Random.NormalIntRange(Bulletmin(SubMachinegun.this.buffedLvl()),
                    Bulletmax(SubMachinegun.this.buffedLvl()));
        ...
        public int proc(Char attacker, Char defender, int damage) {
            ...
            if (SubMachinegun.this.enchantment == null
            ...
            } else if (SubMachinegun.this.enchantment == null
                    && Random.Int(3) < hero.pointsInTalent(Talent.SHARED_ENCHANTMENT)
                    && hero.buff(MagicImmune.class) == null
                    && bow2 != null
        ...
        @Override
        public int STRReq(int lvl) {
            if (SubMachinegun.this.masteryPotionBonus) {
                return STRReq(tier, SubMachinegun.this.buffedLvl()) - 2;
            }
