...
public class AntimaterRifleAP extends MeleeWeapon {
    ...
    public String info() {
        ...
        if (levelKnown) {
            ...
            info += "\n\n" + Messages.get(AntimaterRifleAP.class, "stats_known",
                    Bulletmin(AntimaterRifleAP.this.buffedLvl()),
                    Bulletmax(AntimaterRifleAP.this.buffedLvl()),
            ...
            info += "\n\n" + Messages.get(AntimaterRifleAP.class, "stats_unknown",
                    Bulletmin(0),
                    Bulletmax(0),
                    round, max_round, new DecimalFormat("#.##").format(reload_time));
        }
    ...
    public AntimaterRifleAP.Bullet knockBullet(){
        return new AntimaterRifleAP.Bullet();
    }
    public class Bullet extends MissileWeapon {
        ...
        public int buffedLvl(){
            return AntimaterRifleAP.this.buffedLvl();
        }
        ...
        public int damageRoll(Char owner) {
            ...
            int bulletdamage = Random.NormalIntRange(Bulletmin(AntimaterRifleAP.this.buffedLvl()),
                    Bulletmax(AntimaterRifleAP.this.buffedLvl()));
        ...
        public boolean hasEnchant(Class<? extends Enchantment> type, Char owner) {
            return AntimaterRifleAP.this.hasEnchant(type, owner);
        }
        ...
        public int proc(Char attacker, Char defender, int damage) {
            ...
            if (AntimaterRifleAP.this.enchantment == null
            ...
            } else if (AntimaterRifleAP.this.enchantment == null
                    && Random.Int(3) < hero.pointsInTalent(Talent.SHARED_ENCHANTMENT)
                    && hero.buff(MagicImmune.class) == null
                    && bow2 != null
                ...
                return AntimaterRifleAP.this.proc(attacker, defender, damage);
            }
        }
        ...
        public float delayFactor(Char user) {
            if (hero.buff(Riot.riotTracker.class) != null) {
                return AntimaterRifleAP.this.delayFactor(user)/2f;
            } else {
                return AntimaterRifleAP.this.delayFactor(user);
            }
        }
