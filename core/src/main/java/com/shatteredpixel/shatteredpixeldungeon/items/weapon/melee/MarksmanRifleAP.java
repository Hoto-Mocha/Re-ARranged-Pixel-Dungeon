...
public class MarksmanRifleAP extends MeleeWeapon {
    ...
    public String info() {
        ...
        if (levelKnown) {
            ...
            info += "\n\n" + Messages.get(MarksmanRifleAP.class, "stats_known",
                    Bulletmin(MarksmanRifleAP.this.buffedLvl()),
                    Bulletmax(MarksmanRifleAP.this.buffedLvl()),
            ...
            info += "\n\n" + Messages.get(MarksmanRifleAP.class, "stats_unknown",
                    Bulletmin(0),
                    Bulletmax(0),
                    round, max_round, new DecimalFormat("#.##").format(reload_time));
        }
    ...
    public MarksmanRifleAP.Bullet knockBullet(){
        return new MarksmanRifleAP.Bullet();
    }
    public class Bullet extends MissileWeapon {
        ...
        public int buffedLvl(){
            return MarksmanRifleAP.this.buffedLvl();
        }
        ...
        public int damageRoll(Char owner) {
            ...
            int bulletdamage = Random.NormalIntRange(Bulletmin(MarksmanRifleAP.this.buffedLvl()),
                    Bulletmax(MarksmanRifleAP.this.buffedLvl()));
        ...
        public boolean hasEnchant(Class<? extends Enchantment> type, Char owner) {
            return MarksmanRifleAP.this.hasEnchant(type, owner);
        }
        ...
        public int proc(Char attacker, Char defender, int damage) {
            ...
            if (MarksmanRifleAP.this.enchantment == null
            ...
            } else if (MarksmanRifleAP.this.enchantment == null
                    && Random.Int(3) < hero.pointsInTalent(Talent.SHARED_ENCHANTMENT)
                    && hero.buff(MagicImmune.class) == null
                    && bow2 != null
                ...
                return MarksmanRifleAP.this.proc(attacker, defender, damage);
            }
        }
        ...
        public float delayFactor(Char user) {
            if (hero.buff(Riot.riotTracker.class) != null) {
                return MarksmanRifleAP.this.delayFactor(user)/2f;
            } else {
                return MarksmanRifleAP.this.delayFactor(user);
            }
        }
        ...
        @Override
        public int STRReq(int lvl) {
            if (MarksmanRifleAP.this.masteryPotionBonus) {
                return STRReq(tier, MarksmanRifleAP.this.buffedLvl()) - 2;
            }
            return STRReq(tier, MarksmanRifleAP.this.buffedLvl());
        }
