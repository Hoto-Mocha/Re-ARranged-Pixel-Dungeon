...
public class CrudePistolAP extends MeleeWeapon {
    ...
    public String info() {
        ...
        if (levelKnown) {
            ...
            info += "\n\n" + Messages.get(CrudePistolAP.class, "stats_known",
                    Bulletmin(CrudePistolAP.this.buffedLvl()),
                    Bulletmax(CrudePistolAP.this.buffedLvl()),
            ...
            info += "\n\n" + Messages.get(CrudePistolAP.class, "stats_unknown",
                    Bulletmin(0),
                    Bulletmax(0),
                    round, max_round, new DecimalFormat("#.##").format(reload_time));
        }
    ...
    public CrudePistolAP.Bullet knockBullet(){
        return new CrudePistolAP.Bullet();
    }
    public class Bullet extends MissileWeapon {
        ...
        public int buffedLvl(){
            return CrudePistolAP.this.buffedLvl();
        }
        ...
        public int damageRoll(Char owner) {
            ...
            int bulletdamage = Random.NormalIntRange(Bulletmin(CrudePistolAP.this.buffedLvl()),
                                                     Bulletmax(CrudePistolAP.this.buffedLvl()));
        ...
        public boolean hasEnchant(Class<? extends Enchantment> type, Char owner) {
            return CrudePistolAP.this.hasEnchant(type, owner);
        }
        ...
        public int proc(Char attacker, Char defender, int damage) {
            ...
            if (CrudePistolAP.this.enchantment == null
            ...
            } else if (CrudePistolAP.this.enchantment == null
                    && Random.Int(3) < hero.pointsInTalent(Talent.SHARED_ENCHANTMENT)
                    && hero.buff(MagicImmune.class) == null
                    && bow2 != null
                ...
                return CrudePistolAP.this.proc(attacker, defender, damage);
            }
        }
        ...
        public float delayFactor(Char user) {
            if (hero.hasTalent(Talent.RECOIL_CONTROL)) {
                ...
                if (hero.buff(Riot.riotTracker.class) != null) {
                    return CrudePistolAP.this.delayFactor(user)/2f;
                } else {
                        return CrudePistolAP.this.delayFactor(user);
                }
            }
        }
