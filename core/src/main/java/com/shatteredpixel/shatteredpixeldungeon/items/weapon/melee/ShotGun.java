...
public class ShotGun extends MeleeWeapon {
    ...
    public class Bullet extends MissileWeapon {
        ...
        public int damageRoll(Char owner) {
            ...
            int bulletdamage = Random.NormalIntRange(Bulletmin(ShotGun.this.buffedLvl()),
                    Bulletmax(ShotGun.this.buffedLvl()));
        ...
        public int proc(Char attacker, Char defender, int damage) {
            ...
            if (ShotGun.this.enchantment == null
            ...
            } else if (ShotGun.this.enchantment == null
                    && Random.Int(3) < hero.pointsInTalent(Talent.SHARED_ENCHANTMENT)
                    && hero.buff(MagicImmune.class) == null
                    && bow2 != null
        ...
        public float delayFactor(Char user) {
            if (hero.buff(Riot.riotTracker.class) != null) {
                return ShotGun.this.delayFactor(user)/2f;
            } else {
        ...
        @Override
        public int STRReq(int lvl) {
            if (ShotGun.this.masteryPotionBonus) {
                return STRReq(tier, ShotGun.this.buffedLvl()) - 2;
            }
