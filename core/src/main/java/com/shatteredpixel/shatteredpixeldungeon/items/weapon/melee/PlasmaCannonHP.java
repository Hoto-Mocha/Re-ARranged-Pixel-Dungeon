...
public class PlasmaCannonHP extends MeleeWeapon {
    ...
    public class Bullet extends MissileWeapon {
        ...
        public int buffedLvl(){
            return PlasmaCannonHP.this.buffedLvl();
        }
        ...
        public int proc(Char attacker, Char defender, int damage) {
            ...
            if (PlasmaCannonHP.this.enchantment == null
            ...
            } else if (PlasmaCannonHP.this.enchantment == null
                    && Random.Int(3) < hero.pointsInTalent(Talent.SHARED_ENCHANTMENT)
                    && hero.buff(MagicImmune.class) == null
                    && bow2 != null
        ...
        public int STRReq(int lvl) {
            return PlasmaCannonHP.this.STRReq();
        }
