...
public class MiniGunAP extends MeleeWeapon {
    ...
    public String info() {
        ...
        if (levelKnown) {
            ...
            info += "\n\n" + Messages.get(MiniGunAP.class, "stats_known",
                    Bulletmin(MiniGunAP.this.buffedLvl()),
                    Bulletmax(MiniGunAP.this.buffedLvl()),
            ...
            info += "\n\n" + Messages.get(MiniGunAP.class, "stats_unknown",
                    Bulletmin(0),
                    Bulletmax(0),
                    round, max_round, new DecimalFormat("#.##").format(reload_time));
        }
    ...
    public MiniGunAP.Bullet knockBullet(){
        return new MiniGunAP.Bullet();
    }
    public class Bullet extends MissileWeapon {
        ...
        public int buffedLvl(){
            return MiniGunAP.this.buffedLvl();
        }
        ...
        public int damageRoll(Char owner) {
            ...
            int bulletdamage = Random.NormalIntRange(Bulletmin(MiniGunAP.this.buffedLvl()),
                    Bulletmax(MiniGunAP.this.buffedLvl()));
        ...
        public boolean hasEnchant(Class<? extends Enchantment> type, Char owner) {
            return MiniGunAP.this.hasEnchant(type, owner);
        }
        ...
        public int proc(Char attacker, Char defender, int damage) {
            ...
            if (MiniGunAP.this.enchantment == null
            ...
            } else if (MiniGunAP.this.enchantment == null
                    && Random.Int(3) < hero.pointsInTalent(Talent.SHARED_ENCHANTMENT)
                    && hero.buff(MagicImmune.class) == null
                    && bow2 != null
                ...
                return MiniGunAP.this.proc(attacker, defender, damage);
            }
        }
        ...
        public float delayFactor(Char user) {
            if (hero.buff(Riot.riotTracker.class) != null) {
                return MiniGunAP.this.delayFactor(user)/2f;
            } else {
                return MiniGunAP.this.delayFactor(user);
            }
        }
        ...
        @Override
        public int STRReq(int lvl) {
            if (MiniGunAP.this.masteryPotionBonus) {
                return STRReq(tier, MiniGunAP.this.buffedLvl()) - 2;
            }
            return STRReq(tier, MiniGunAP.this.buffedLvl());
        }
