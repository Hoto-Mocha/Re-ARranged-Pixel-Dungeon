...
public class AutoHandgunHP extends MeleeWeapon {
    ...
    public String info() {
        ...
        if (levelKnown) {
            ...
            info += "\n\n" + Messages.get(AutoHandgunHP.class, "stats_known",
                    Bulletmin(AutoHandgunHP.this.buffedLvl()),
                    Bulletmax(AutoHandgunHP.this.buffedLvl()),
            ...
            info += "\n\n" + Messages.get(AutoHandgunHP.class, "stats_unknown",
                    Bulletmin(0),
                    Bulletmax(0),
                    round, max_round, new DecimalFormat("#.##").format(reload_time));
        }
    ...
    public AutoHandgunHP.Bullet knockBullet(){
        return new AutoHandgunHP.Bullet();
    }
    public class Bullet extends MissileWeapon {
        ...
        public int buffedLvl(){
            return AutoHandgunHP.this.buffedLvl();
        }
        ...
        public int damageRoll(Char owner) {
            ...
            int bulletdamage = Random.NormalIntRange(Bulletmin(AutoHandgunHP.this.buffedLvl()),
                    Bulletmax(AutoHandgunHP.this.buffedLvl()));
        ...
        public boolean hasEnchant(Class<? extends Enchantment> type, Char owner) {
            return AutoHandgunHP.this.hasEnchant(type, owner);
        }
        ...
        public int proc(Char attacker, Char defender, int damage) {
            ...
            if (AutoHandgunHP.this.enchantment == null
            ...
            } else if (AutoHandgunHP.this.enchantment == null
                    && Random.Int(3) < hero.pointsInTalent(Talent.SHARED_ENCHANTMENT)
                    && hero.buff(MagicImmune.class) == null
                    && bow2 != null
                ...
                return AutoHandgunHP.this.proc(attacker, defender, damage);
            }
        }
        ...
        public float delayFactor(Char user) {
            if (hero.hasTalent(Talent.RECOIL_CONTROL)) {
                if (hero.buff(Riot.riotTracker.class) != null) {
                    return AutoHandgunHP.this.delayFactor(user)/(2f + 2f * hero.pointsInTalent(Talent.RECOIL_CONTROL)/3f);
                } else {
                    return AutoHandgunHP.this.delayFactor(user)/(1f + hero.pointsInTalent(Talent.RECOIL_CONTROL)/3f);
                }
            } else {
                if (hero.buff(Riot.riotTracker.class) != null) {
                    return AutoHandgunHP.this.delayFactor(user)/2f;
                } else {
                        return AutoHandgunHP.this.delayFactor(user);
                }
            }
        }
        ...
        @Override
        public int STRReq(int lvl) {
            if (AutoHandgunHP.this.masteryPotionBonus) {
                return STRReq(tier, AutoHandgunHP.this.buffedLvl()) - 2;
            }
            return STRReq(tier, AutoHandgunHP.this.buffedLvl());
        }
