...
public class HuntingRifleAP extends MeleeWeapon {
    ...
    public HuntingRifleAP.Bullet knockBullet(){
        return new HuntingRifleAP.Bullet();
    }
    public class Bullet extends MissileWeapon {
        ...
        public int buffedLvl(){
            return HuntingRifleAP.this.buffedLvl();
        }
        ...
        public int damageRoll(Char owner) {
            ...
            int bulletdamage = Random.NormalIntRange(Bulletmin(HuntingRifleAP.this.buffedLvl()),
                    Bulletmax(HuntingRifleAP.this.buffedLvl()));
        ...
        public boolean hasEnchant(Class<? extends Enchantment> type, Char owner) {
            return HuntingRifleAP.this.hasEnchant(type, owner);
        }
        ...
        public int proc(Char attacker, Char defender, int damage) {
            ...
            if (HuntingRifleAP.this.enchantment == null
            ...
            } else if (HuntingRifleAP.this.enchantment == null
                    && Random.Int(3) < hero.pointsInTalent(Talent.SHARED_ENCHANTMENT)
                    && hero.buff(MagicImmune.class) == null
                    && bow2 != null
                ...
                return HuntingRifleAP.this.proc(attacker, defender, damage);
            }
        }
        ...
        public float delayFactor(Char user) {
            if (hero.buff(Riot.riotTracker.class) != null) {
                return HuntingRifleAP.this.delayFactor(user)/2f;
            } else {
                return HuntingRifleAP.this.delayFactor(user);
            }
        }
        ...
        @Override
        public int STRReq(int lvl) {
            if (HuntingRifleAP.this.masteryPotionBonus) {
                return STRReq(tier, HuntingRifleAP.this.buffedLvl()) - 2;
            }
            return STRReq(tier, HuntingRifleAP.this.buffedLvl());
        }
