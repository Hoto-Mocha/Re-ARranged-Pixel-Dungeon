...
public class TacticalHandgunAP extends MeleeWeapon {
    ...
    public String info() {
        ...
        if (levelKnown) {
            ...
            info += "\n\n" + Messages.get(TacticalHandgunAP.class, "stats_known",
                    Bulletmin(TacticalHandgunAP.this.buffedLvl()),
                    Bulletmax(TacticalHandgunAP.this.buffedLvl()),
            ...
            info += "\n\n" + Messages.get(TacticalHandgunAP.class, "stats_unknown",
                    Bulletmin(0),
                    Bulletmax(0),
                    round, max_round, new DecimalFormat("#.##").format(reload_time));
        }
    ...
    public TacticalHandgunAP.Bullet knockBullet(){
        return new TacticalHandgunAP.Bullet();
    }
    public class Bullet extends MissileWeapon {
        ...
        public int buffedLvl(){
            return TacticalHandgunAP.this.buffedLvl();
        }
        ...
        public int damageRoll(Char owner) {
            ...
            int bulletdamage = Random.NormalIntRange(Bulletmin(TacticalHandgunAP.this.buffedLvl()),
                    Bulletmax(TacticalHandgunAP.this.buffedLvl()));
        ...
        public boolean hasEnchant(Class<? extends Enchantment> type, Char owner) {
            return TacticalHandgunAP.this.hasEnchant(type, owner);
        }
        ...
        public int proc(Char attacker, Char defender, int damage) {
            ...
            if (TacticalHandgunAP.this.enchantment == null
            ...
            } else if (TacticalHandgunAP.this.enchantment == null
                    && Random.Int(3) < hero.pointsInTalent(Talent.SHARED_ENCHANTMENT)
                    && hero.buff(MagicImmune.class) == null
                    && bow2 != null
                ...
                return TacticalHandgunAP.this.proc(attacker, defender, damage);
            }
        }
        ...
        public float delayFactor(Char user) {
            if (hero.hasTalent(Talent.RECOIL_CONTROL)) {
                if (hero.buff(Riot.riotTracker.class) != null) {
                    return TacticalHandgunAP.this.delayFactor(user)/(2f + 2f * hero.pointsInTalent(Talent.RECOIL_CONTROL)/3f);
                } else {
                    return TacticalHandgunAP.this.delayFactor(user)/(1f + hero.pointsInTalent(Talent.RECOIL_CONTROL)/3f);
                }
            } else {
                if (hero.buff(Riot.riotTracker.class) != null) {
                    return TacticalHandgunAP.this.delayFactor(user)/2f;
                } else {
                        return TacticalHandgunAP.this.delayFactor(user);
                }
            }
        }
