...
public class HeavyMachinegunHP extends MeleeWeapon {
    ...
    public String info() {
        ...
        if (levelKnown) {
            ...
            info += "\n\n" + Messages.get(HeavyMachinegunHP.class, "stats_known",
                    Bulletmin(HeavyMachinegunHP.this.buffedLvl()),
                    Bulletmax(HeavyMachinegunHP.this.buffedLvl()),
            ...
            info += "\n\n" + Messages.get(HeavyMachinegunHP.class, "stats_unknown",
                    Bulletmin(0),
                    Bulletmax(0),
                    round, max_round, new DecimalFormat("#.##").format(reload_time));
        }
    ...
    public HeavyMachinegunHP.Bullet knockBullet(){
        return new HeavyMachinegunHP.Bullet();
    }
    public class Bullet extends MissileWeapon {
        ...
        public int buffedLvl(){
            return HeavyMachinegunHP.this.buffedLvl();
        }
        ...
        public int damageRoll(Char owner) {
            ...
            int bulletdamage = Random.NormalIntRange(Bulletmin(HeavyMachinegunHP.this.buffedLvl()),
                    Bulletmax(HeavyMachinegunHP.this.buffedLvl()));
        ...
        public boolean hasEnchant(Class<? extends Enchantment> type, Char owner) {
            return HeavyMachinegunHP.this.hasEnchant(type, owner);
        }
        ...
        public int proc(Char attacker, Char defender, int damage) {
            ...
            if (HeavyMachinegunHP.this.enchantment == null
            ...
            } else if (HeavyMachinegunHP.this.enchantment == null
                    && Random.Int(3) < hero.pointsInTalent(Talent.SHARED_ENCHANTMENT)
                    && hero.buff(MagicImmune.class) == null
                    && bow2 != null
                ...
                return HeavyMachinegunHP.this.proc(attacker, defender, damage);
            }
        }
        ...
        public float delayFactor(Char user) {
            if (hero.buff(Riot.riotTracker.class) != null) {
                return HeavyMachinegunHP.this.delayFactor(user)/2f;
            } else {
                return HeavyMachinegunHP.this.delayFactor(user);
            }
        }
        ...
        @Override
        public int STRReq(int lvl) {
            if (HeavyMachinegunHP.this.masteryPotionBonus) {
                return STRReq(tier, HeavyMachinegunHP.this.buffedLvl()) - 2;
            }
            return STRReq(tier, HeavyMachinegunHP.this.buffedLvl());
        }
