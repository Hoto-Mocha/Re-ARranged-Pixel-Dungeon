...
public class NaturesBow extends Weapon {
	...
	public String info() {
		...
		info += "\n\n" + Messages.get( NaturesBow.class, "stats",
	...
	public class SpiritArrow extends MissileWeapon {
		...
		{
			image = ItemSpriteSheet.NATURAL_ARROW;
		...
		@Override
		public int damageRoll(Char owner) {
			return NaturesBow.this.damageRoll(owner);
		}
		
		@Override
		public boolean hasEnchant(Class<? extends Enchantment> type, Char owner) {
			return NaturesBow.this.hasEnchant(type, owner);
		}
		
		@Override
		public int proc(Char attacker, Char defender, int damage) {
			return NaturesBow.this.proc(attacker, defender, damage);
		}
		
		@Override
		public float delayFactor(Char user) {
			return NaturesBow.this.delayFactor(user);
		}
		...
		@Override
		public int STRReq(int lvl) {
			return NaturesBow.this.STRReq(lvl);
		}
		...
		public void cast(final Hero user, final int dst) {
			...
			NaturesBow.this.targetPos = cell;
			if (sniperSpecial && NaturesBow.this.augment == Augment.SPEED){
	...
	private CellSelector.Listener shooter = new CellSelector.Listener() {
		...
		public String prompt() {
			return Messages.get(NaturesBow.class, "prompt");
		}
	};
}
