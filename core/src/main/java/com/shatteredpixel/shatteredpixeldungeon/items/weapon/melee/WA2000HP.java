...
public class WA2000HP extends MeleeWeapon {
    ...
    public String info() {
        ...
        if (levelKnown) {
            ...
            info += "\n\n" + Messages.get(WA2000HP.class, "stats_known",
                    Bulletmin(WA2000HP.this.buffedLvl()),
                    Bulletmax(WA2000HP.this.buffedLvl()),
            ...
            info += "\n\n" + Messages.get(WA2000HP.class, "stats_unknown",
                    Bulletmin(0),
                    Bulletmax(0),
                    round, max_round, new DecimalFormat("#.##").format(reload_time));
        }
    ...
    public WA2000HP.Bullet knockBullet(){
        return new WA2000HP.Bullet();
    }
    public class Bullet extends MissileWeapon {
        ...
        public int damageRoll(Char owner) {
            ...
            int bulletdamage = Random.NormalIntRange(Bulletmin(WA2000HP.this.buffedLvl()),
                    Bulletmax(WA2000HP.this.buffedLvl()));
        ...
        public boolean hasEnchant(Class<? extends Enchantment> type, Char owner) {
            return WA2000HP.this.hasEnchant(type, owner);
        }
        ...
        public int proc(Char attacker, Char defender, int damage) {
            ...
            if (WA2000HP.this.enchantment == null
            ...
            } else if (WA2000HP.this.enchantment == null
                    && Random.Int(3) < hero.pointsInTalent(Talent.SHARED_ENCHANTMENT)
                    && hero.buff(MagicImmune.class) == null
                    && bow2 != null
                ...
                return WA2000HP.this.proc(attacker, defender, damage);
            }
        }
        ...
        public float delayFactor(Char user) {
            if (hero.buff(Riot.riotTracker.class) != null) {
                return WA2000HP.this.delayFactor(user)/2f;
            } else {
                return WA2000HP.this.delayFactor(user);
            }
        }
