...
public class AssultRifle extends MeleeWeapon {
    ...
    public class Bullet extends MissileWeapon {
        ...
        public int buffedLvl(){
            return AssultRifle.this.buffedLvl();
        }
        ...
        public int damageRoll(Char owner) {
            ...
            int bulletdamage = Random.NormalIntRange(Bulletmin(AssultRifle.this.buffedLvl()),
                    Bulletmax(AssultRifle.this.buffedLvl()));
        ...
        public int proc(Char attacker, Char defender, int damage) {
            ...
            if (AssultRifle.this.enchantment == null
            ...
            } else if (AssultRifle.this.enchantment == null
                    && Random.Int(3) < hero.pointsInTalent(Talent.SHARED_ENCHANTMENT)
                    && hero.buff(MagicImmune.class) == null
                    && bow2 != null
        ...
        public float delayFactor(Char user) {
            if (hero.buff(Riot.riotTracker.class) != null) {
                return AssultRifle.this.delayFactor(user)/2f;
            } else {
        ...
        @Override
        public int STRReq(int lvl) {
            return AssultRifle.this.STRReq();
        }
