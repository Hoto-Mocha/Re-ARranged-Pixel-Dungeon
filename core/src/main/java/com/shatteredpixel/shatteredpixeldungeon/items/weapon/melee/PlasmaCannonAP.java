...
public class PlasmaCannonAP extends MeleeWeapon {
    ...
    public String info() {
        ...
        if (levelKnown) {
            ...
            info += "\n\n" + Messages.get(PlasmaCannonAP.class, "stats_known",
                    Bulletmin(PlasmaCannonAP.this.buffedLvl()),
                    Bulletmax(PlasmaCannonAP.this.buffedLvl()),
            ...
            info += "\n\n" + Messages.get(PlasmaCannonAP.class, "stats_unknown",
                    Bulletmin(0),
                    Bulletmax(0),
                    round, max_round, reload_time);
        }
    ...
    public PlasmaCannonAP.Bullet knockBullet(){
        return new PlasmaCannonAP.Bullet();
    }
    public class Bullet extends MissileWeapon {
        ...
        public int buffedLvl(){
            return PlasmaCannonAP.this.buffedLvl();
        }
        ...
        public int damageRoll(Char owner) {
            ...
            int bulletdamage = Random.NormalIntRange(Bulletmin(PlasmaCannonAP.this.buffedLvl()),
                    Bulletmax(PlasmaCannonAP.this.buffedLvl()));
        ...
        public boolean hasEnchant(Class<? extends Enchantment> type, Char owner) {
            return PlasmaCannonAP.this.hasEnchant(type, owner);
        }
        ...
        public int proc(Char attacker, Char defender, int damage) {
            ...
            if (PlasmaCannonAP.this.enchantment == null
            ...
            } else if (PlasmaCannonAP.this.enchantment == null
                    && Random.Int(3) < hero.pointsInTalent(Talent.SHARED_ENCHANTMENT)
                    && hero.buff(MagicImmune.class) == null
                    && bow2 != null
                ...
                return PlasmaCannonAP.this.proc(attacker, defender, damage);
            }
        }
        ...
        public float delayFactor(Char user) {
            if (hero.buff(Riot.riotTracker.class) != null) {
                return PlasmaCannonAP.this.delayFactor(user)/2f;
            } else {
                return PlasmaCannonAP.this.delayFactor(user);
            }
        }
        ...
        protected void onThrow(int cell) {
            ...
            int maxDist = 10+2*PlasmaCannonAP.curItem.buffedLvl();
