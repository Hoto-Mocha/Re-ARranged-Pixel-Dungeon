...
public class CarbineAP extends MeleeWeapon {
    ...
    public String info() {
        ...
        if (levelKnown) {
            ...
            info += "\n\n" + Messages.get(CarbineAP.class, "stats_known",
                    Bulletmin(CarbineAP.this.buffedLvl()),
                    Bulletmax(CarbineAP.this.buffedLvl()),
            ...
            info += "\n\n" + Messages.get(CarbineAP.class, "stats_unknown",
                    Bulletmin(0),
                    Bulletmax(0),
                    round, max_round, new DecimalFormat("#.##").format(reload_time));
        }
    ...
    public CarbineAP.Bullet knockBullet(){
        return new CarbineAP.Bullet();
    }
    public class Bullet extends MissileWeapon {
        ...
        public int buffedLvl(){
            return CarbineAP.this.buffedLvl();
        }
        ...
        public int damageRoll(Char owner) {
            ...
            int bulletdamage = Random.NormalIntRange(Bulletmin(CarbineAP.this.buffedLvl()),
                    Bulletmax(CarbineAP.this.buffedLvl()));
        ...
        public boolean hasEnchant(Class<? extends Enchantment> type, Char owner) {
            return CarbineAP.this.hasEnchant(type, owner);
        }
        ...
        public int proc(Char attacker, Char defender, int damage) {
            ...
            if (CarbineAP.this.enchantment == null
            ...
            } else if (CarbineAP.this.enchantment == null
                    && Random.Int(3) < hero.pointsInTalent(Talent.SHARED_ENCHANTMENT)
                    && hero.buff(MagicImmune.class) == null
                    && bow2 != null
                ...
                return CarbineAP.this.proc(attacker, defender, damage);
            }
        }
        ...
        public float delayFactor(Char user) {
            if (hero.buff(Riot.riotTracker.class) != null) {
                return CarbineAP.this.delayFactor(user)/2f;
            } else {
                return CarbineAP.this.delayFactor(user);
            }
        }
