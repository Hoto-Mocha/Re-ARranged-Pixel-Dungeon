...
public class AssultRifleAP extends MeleeWeapon {
    ...
    public String info() {
        ...
        if (levelKnown) {
            ...
            info += "\n\n" + Messages.get(AssultRifleAP.class, "stats_known",
                    Bulletmin(AssultRifleAP.this.buffedLvl()),
                    Bulletmax(AssultRifleAP.this.buffedLvl()),
            ...
            info += "\n\n" + Messages.get(AssultRifleAP.class, "stats_unknown",
                    Bulletmin(0),
                    Bulletmax(0),
                    round, max_round, new DecimalFormat("#.##").format(reload_time));
        }
    ...
    public AssultRifleAP.Bullet knockBullet(){
        return new AssultRifleAP.Bullet();
    }
    public class Bullet extends MissileWeapon {
        ...
        public int buffedLvl(){
            return AssultRifleAP.this.buffedLvl();
        }
        ...
        public int damageRoll(Char owner) {
            ...
            int bulletdamage = Random.NormalIntRange(Bulletmin(AssultRifleAP.this.buffedLvl()),
                    Bulletmax(AssultRifleAP.this.buffedLvl()));
        ...
        public boolean hasEnchant(Class<? extends Enchantment> type, Char owner) {
            return AssultRifleAP.this.hasEnchant(type, owner);
        }
        ...
        public int proc(Char attacker, Char defender, int damage) {
            ...
            if (AssultRifleAP.this.enchantment == null
            ...
            } else if (AssultRifleAP.this.enchantment == null
                    && Random.Int(3) < hero.pointsInTalent(Talent.SHARED_ENCHANTMENT)
                    && hero.buff(MagicImmune.class) == null
                    && bow2 != null
                ...
                return AssultRifleAP.this.proc(attacker, defender, damage);
            }
        }
        ...
        public float delayFactor(Char user) {
            if (hero.buff(Riot.riotTracker.class) != null) {
                return AssultRifleAP.this.delayFactor(user)/2f;
            } else {
                return AssultRifleAP.this.delayFactor(user);
            }
        }
        ...
        @Override
        public int STRReq(int lvl) {
            if (AssultRifleAP.this.masteryPotionBonus) {
                return STRReq(tier, AssultRifleAP.this.buffedLvl()) - 2;
            }
            return STRReq(tier, AssultRifleAP.this.buffedLvl());
        }
