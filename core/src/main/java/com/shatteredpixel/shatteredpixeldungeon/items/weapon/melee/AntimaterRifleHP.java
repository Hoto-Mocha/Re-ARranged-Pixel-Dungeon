...
public class AntimaterRifleHP extends MeleeWeapon {
    ...
    public String info() {
        ...
        if (levelKnown) {
            ...
            info += "\n\n" + Messages.get(AntimaterRifleHP.class, "stats_known",
                    Bulletmin(AntimaterRifleHP.this.buffedLvl()),
                    Bulletmax(AntimaterRifleHP.this.buffedLvl()),
            ...
            info += "\n\n" + Messages.get(AntimaterRifleHP.class, "stats_unknown",
                    Bulletmin(0),
                    Bulletmax(0),
                    round, max_round, new DecimalFormat("#.##").format(reload_time));
        }
    ...
    public AntimaterRifleHP.Bullet knockBullet(){
        return new AntimaterRifleHP.Bullet();
    }
    public class Bullet extends MissileWeapon {
        ...
        public int buffedLvl(){
            return AntimaterRifleHP.this.buffedLvl();
        }
        ...
        public int damageRoll(Char owner) {
            ...
            int bulletdamage = Random.NormalIntRange(Bulletmin(AntimaterRifleHP.this.buffedLvl()),
                    Bulletmax(AntimaterRifleHP.this.buffedLvl()));
        ...
        public boolean hasEnchant(Class<? extends Enchantment> type, Char owner) {
            return AntimaterRifleHP.this.hasEnchant(type, owner);
        }
        ...
        public int proc(Char attacker, Char defender, int damage) {
            ...
            if (AntimaterRifleHP.this.enchantment == null
            ...
            } else if (AntimaterRifleHP.this.enchantment == null
                    && Random.Int(3) < hero.pointsInTalent(Talent.SHARED_ENCHANTMENT)
                    && hero.buff(MagicImmune.class) == null
                    && bow2 != null
                ...
                return AntimaterRifleHP.this.proc(attacker, defender, damage);
            }
        }
        ...
        public float delayFactor(Char user) {
            if (hero.buff(Riot.riotTracker.class) != null) {
                return AntimaterRifleHP.this.delayFactor(user)/2f;
            } else {
                return AntimaterRifleHP.this.delayFactor(user);
            }
        }
        ...
        @Override
        public int STRReq(int lvl) {
            if (AntimaterRifleHP.this.masteryPotionBonus) {
                return STRReq(tier, AntimaterRifleHP.this.buffedLvl()) - 2;
            }
            return STRReq(tier, AntimaterRifleHP.this.buffedLvl());
        }
