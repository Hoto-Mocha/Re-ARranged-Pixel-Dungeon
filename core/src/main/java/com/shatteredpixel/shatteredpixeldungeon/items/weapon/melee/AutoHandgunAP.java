...
public class AutoHandgunAP extends MeleeWeapon {
    ...
    public String info() {
        ...
        if (levelKnown) {
            ...
            info += "\n\n" + Messages.get(AutoHandgunAP.class, "stats_known",
                    Bulletmin(AutoHandgunAP.this.buffedLvl()),
                    Bulletmax(AutoHandgunAP.this.buffedLvl()),
            ...
            info += "\n\n" + Messages.get(AutoHandgunAP.class, "stats_unknown",
                    Bulletmin(0),
                    Bulletmax(0),
                    round, max_round, new DecimalFormat("#.##").format(reload_time));
        }
    ...
    public AutoHandgunAP.Bullet knockBullet(){
        return new AutoHandgunAP.Bullet();
    }
    public class Bullet extends MissileWeapon {
        ...
        public int buffedLvl(){
            return AutoHandgunAP.this.buffedLvl();
        }
        ...
        public int damageRoll(Char owner) {
            ...
            int bulletdamage = Random.NormalIntRange(Bulletmin(AutoHandgunAP.this.buffedLvl()),
                    Bulletmax(AutoHandgunAP.this.buffedLvl()));
        ...
        public boolean hasEnchant(Class<? extends Enchantment> type, Char owner) {
            return AutoHandgunAP.this.hasEnchant(type, owner);
        }
        ...
        public int proc(Char attacker, Char defender, int damage) {
            ...
            if (AutoHandgunAP.this.enchantment == null
            ...
            } else if (AutoHandgunAP.this.enchantment == null
                    && Random.Int(3) < hero.pointsInTalent(Talent.SHARED_ENCHANTMENT)
                    && hero.buff(MagicImmune.class) == null
                    && bow2 != null
                ...
                return AutoHandgunAP.this.proc(attacker, defender, damage);
            }
        }
        ...
        public float delayFactor(Char user) {
            if (hero.hasTalent(Talent.RECOIL_CONTROL)) {
                if (hero.buff(Riot.riotTracker.class) != null) {
                    return AutoHandgunAP.this.delayFactor(user)/(2f + 2f * hero.pointsInTalent(Talent.RECOIL_CONTROL)/3f);
                } else {
                    return AutoHandgunAP.this.delayFactor(user)/(1f + hero.pointsInTalent(Talent.RECOIL_CONTROL)/3f);
                }
            } else {
                if (hero.buff(Riot.riotTracker.class) != null) {
                    return AutoHandgunAP.this.delayFactor(user)/2f;
                } else {
                        return AutoHandgunAP.this.delayFactor(user);
                }
            }
        }
        ...
        @Override
        public int STRReq(int lvl) {
            if (AutoHandgunAP.this.masteryPotionBonus) {
                return STRReq(tier, AutoHandgunAP.this.buffedLvl()) - 2;
            }
            return STRReq(tier, AutoHandgunAP.this.buffedLvl());
        }
