...
public class MiniGunHP extends MeleeWeapon {
    ...
    public String info() {
        ...
        if (levelKnown) {
            ...
            info += "\n\n" + Messages.get(MiniGunHP.class, "stats_known",
                    Bulletmin(MiniGunHP.this.buffedLvl()),
                    Bulletmax(MiniGunHP.this.buffedLvl()),
            ...
            info += "\n\n" + Messages.get(MiniGunHP.class, "stats_unknown",
                    Bulletmin(0),
                    Bulletmax(0),
                    round, max_round, new DecimalFormat("#.##").format(reload_time));
        }
    ...
    public MiniGunHP.Bullet knockBullet(){
        return new MiniGunHP.Bullet();
    }
    public class Bullet extends MissileWeapon {
        ...
        public int buffedLvl(){
            return MiniGunHP.this.buffedLvl();
        }
        ...
        public int damageRoll(Char owner) {
            ...
            int bulletdamage = Random.NormalIntRange(Bulletmin(MiniGunHP.this.buffedLvl()),
                    Bulletmax(MiniGunHP.this.buffedLvl()));
        ...
        public boolean hasEnchant(Class<? extends Enchantment> type, Char owner) {
            return MiniGunHP.this.hasEnchant(type, owner);
        }
        ...
        public int proc(Char attacker, Char defender, int damage) {
            ...
            if (MiniGunHP.this.enchantment == null
            ...
            } else if (MiniGunHP.this.enchantment == null
                    && Random.Int(3) < hero.pointsInTalent(Talent.SHARED_ENCHANTMENT)
                    && hero.buff(MagicImmune.class) == null
                    && bow2 != null
                ...
                return MiniGunHP.this.proc(attacker, defender, damage);
            }
        }
        ...
        public float delayFactor(Char user) {
            if (hero.buff(Riot.riotTracker.class) != null) {
                return MiniGunHP.this.delayFactor(user)/2f;
            } else {
                return MiniGunHP.this.delayFactor(user);
            }
        }
