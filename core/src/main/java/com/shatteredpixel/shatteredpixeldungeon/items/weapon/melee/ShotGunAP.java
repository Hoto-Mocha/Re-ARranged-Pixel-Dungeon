...
public class ShotGunAP extends MeleeWeapon {
    ...
    public String info() {
        ...
        if (levelKnown) {
            ...
            info += "\n\n" + Messages.get(ShotGunAP.class, "stats_known",
                    Bulletmin(ShotGunAP.this.buffedLvl()),
                    Bulletmax(ShotGunAP.this.buffedLvl()),
            ...
            info += "\n\n" + Messages.get(ShotGunAP.class, "stats_unknown",
                    Bulletmin(0),
                    Bulletmax(0),
                    round, max_round, new DecimalFormat("#.##").format(reload_time));
        }
    ...
    public ShotGunAP.Bullet knockBullet(){
        return new ShotGunAP.Bullet();
    }
    public class Bullet extends MissileWeapon {
        ...
        public int buffedLvl(){
            return ShotGunAP.this.buffedLvl();
        }
        ...
        public int damageRoll(Char owner) {
            ...
            int bulletdamage = Random.NormalIntRange(Bulletmin(ShotGunAP.this.buffedLvl()),
                    Bulletmax(ShotGunAP.this.buffedLvl()));
        ...
        public boolean hasEnchant(Class<? extends Enchantment> type, Char owner) {
            return ShotGunAP.this.hasEnchant(type, owner);
        }
        ...
        public int proc(Char attacker, Char defender, int damage) {
            ...
            if (ShotGunAP.this.enchantment == null
            ...
            } else if (ShotGunAP.this.enchantment == null
                    && Random.Int(3) < hero.pointsInTalent(Talent.SHARED_ENCHANTMENT)
                    && hero.buff(MagicImmune.class) == null
                    && bow2 != null
                ...
                return ShotGunAP.this.proc(attacker, defender, damage);
            }
        }
