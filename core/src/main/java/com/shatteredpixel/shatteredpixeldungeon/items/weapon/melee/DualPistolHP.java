    ...
    public void execute(Hero hero, String action) {
        ...
        if (action.equals(AC_SHOOT)) {
            ...
            if (!isEquipped( hero )) {
                ...
                if (round <= 0) {
                    reload_time = (hero.hasTalent(Talent.HEAVY_GUNNER) && Random.Int(10) < hero.pointsInTalent(Talent.HEAVY_GUNNER)) ? 0 : 2f* RingOfReload.reloadMultiplier(Dungeon.hero);                    reload();
                } else {
                    reload_time = (hero.hasTalent(Talent.HEAVY_GUNNER) && Random.Int(10) < hero.pointsInTalent(Talent.HEAVY_GUNNER)) ? 0 : 2f* RingOfReload.reloadMultiplier(Dungeon.hero);                    usesTargeting = true;
                    curUser = hero;
                    curItem = this;
