...
public class AutoRifleHP extends MeleeWeapon {
    ...
    public String info() {
        ...
        if (levelKnown) {
            ...
            info += "\n\n" + Messages.get(AutoRifleHP.class, "stats_known",
                    Bulletmin(AutoRifleHP.this.buffedLvl()),
                    Bulletmax(AutoRifleHP.this.buffedLvl()),
            ...
            info += "\n\n" + Messages.get(AutoRifleHP.class, "stats_unknown",
                    Bulletmin(0),
                    Bulletmax(0),
                    round, max_round, new DecimalFormat("#.##").format(reload_time));
        }
    ...
    public AutoRifleHP.Bullet knockBullet(){
        return new AutoRifleHP.Bullet();
    }
    public class Bullet extends MissileWeapon {
        ...
        public int buffedLvl(){
            return AutoRifleHP.this.buffedLvl();
        }
        ...
        public int damageRoll(Char owner) {
            ...
            int bulletdamage = Random.NormalIntRange(Bulletmin(AutoRifleHP.this.buffedLvl()),
                    Bulletmax(AutoRifleHP.this.buffedLvl()));
        ...
        public boolean hasEnchant(Class<? extends Enchantment> type, Char owner) {
            return AutoRifleHP.this.hasEnchant(type, owner);
        }
        ...
        public int proc(Char attacker, Char defender, int damage) {
            ...
            if (AutoRifleHP.this.enchantment == null
            ...
            } else if (AutoRifleHP.this.enchantment == null
                    && Random.Int(3) < hero.pointsInTalent(Talent.SHARED_ENCHANTMENT)
                    && hero.buff(MagicImmune.class) == null
                    && bow2 != null
                ...
                return AutoRifleHP.this.proc(attacker, defender, damage);
            }
        }
        ...
        public float delayFactor(Char user) {
            if (hero.buff(Riot.riotTracker.class) != null) {
                return AutoRifleHP.this.delayFactor(user)/2f;
            } else {
                return AutoRifleHP.this.delayFactor(user);
            }
        }
        ...
        @Override
        public int STRReq(int lvl) {
            if (AutoRifleHP.this.masteryPotionBonus) {
                return STRReq(tier, AutoRifleHP.this.buffedLvl()) - 2;
            }
            return STRReq(tier, AutoRifleHP.this.buffedLvl());
        }
