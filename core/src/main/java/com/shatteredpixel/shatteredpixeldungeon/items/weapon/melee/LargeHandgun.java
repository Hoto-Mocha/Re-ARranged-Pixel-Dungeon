...
public class LargeHandgun extends MeleeWeapon {
    ...
    public String info() {
        ...
        if (levelKnown) {
            ...
            info += "\n\n" + Messages.get(LargeHandgun.class, "stats_known",
                    Bulletmin(LargeHandgun.this.buffedLvl()),
                    Bulletmax(LargeHandgun.this.buffedLvl()),
            ...
            info += "\n\n" + Messages.get(LargeHandgun.class, "stats_unknown",
                    Bulletmin(0),
                    Bulletmax(0),
                    round, max_round, reload_time);
        }
    ...
    public LargeHandgun.Bullet knockBullet(){
        return new LargeHandgun.Bullet();
    }
    public class Bullet extends MissileWeapon {
        ...
        public int damageRoll(Char owner) {
            ...
            int bulletdamage = Random.NormalIntRange(Bulletmin(LargeHandgun.this.buffedLvl()),
                    Bulletmax(LargeHandgun.this.buffedLvl()));
        ...
        public boolean hasEnchant(Class<? extends Enchantment> type, Char owner) {
            return LargeHandgun.this.hasEnchant(type, owner);
        }

        @Override
        public int proc(Char attacker, Char defender, int damage) {
            return LargeHandgun.this.proc(attacker, defender, damage);
        }
        ...
        public float delayFactor(Char user) {
            if (hero.hasTalent(Talent.RECOIL_CONTROL)) {
                if (hero.buff(Riot.riotTracker.class) != null) {
                    return LargeHandgun.this.delayFactor(user)/(2f + 2f * hero.pointsInTalent(Talent.RECOIL_CONTROL)/3f);
                } else {
                    return LargeHandgun.this.delayFactor(user)/(1f + hero.pointsInTalent(Talent.RECOIL_CONTROL)/3f);
                }
            } else {
                if (hero.buff(Riot.riotTracker.class) != null) {
        ...
        @Override
        public int STRReq(int lvl) {
            if (LargeHandgun.this.masteryPotionBonus) {
                return STRReq(tier, LargeHandgun.this.buffedLvl()) - 2;
            }
            return STRReq(tier, LargeHandgun.this.buffedLvl());
        }
    ...
    public static class Recipe extends com.shatteredpixel.shatteredpixeldungeon.items.Recipe.SimpleRecipe {
        ...
        {
            inputs =  new Class[]{Magnum.class, APBullet.class, HPBullet.class};
