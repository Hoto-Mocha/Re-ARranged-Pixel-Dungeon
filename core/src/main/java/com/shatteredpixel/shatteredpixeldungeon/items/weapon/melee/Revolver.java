...
public class Revolver extends MeleeWeapon {
    ...
    public String info() {
        ...
        if (levelKnown) {
            ...
            info += "\n\n" + Messages.get(Revolver.class, "stats_known",
                    Bulletmin(Revolver.this.buffedLvl()),
                    Bulletmax(Revolver.this.buffedLvl()),
            ...
            info += "\n\n" + Messages.get(Revolver.class, "stats_unknown",
                    Bulletmin(0),
                    Bulletmax(0),
                    round, max_round, new DecimalFormat("#.##").format(reload_time));
        }
    ...
    public Revolver.Bullet knockBullet(){
    ...
    public class Bullet extends MissileWeapon {
        ...
        public int buffedLvl(){
            return Revolver.this.buffedLvl();
        }
        ...
        public int damageRoll(Char owner) {
            ...
            int bulletdamage = Random.NormalIntRange(Bulletmin(Revolver.this.buffedLvl()),
                    Bulletmax(Revolver.this.buffedLvl()));
        ...
        public boolean hasEnchant(Class<? extends Enchantment> type, Char owner) {
            return Revolver.this.hasEnchant(type, owner);
        }
        ...
        public int proc(Char attacker, Char defender, int damage) {
            ...
            if (Revolver.this.enchantment == null
            ...
            } else if (Revolver.this.enchantment == null
                    && Random.Int(3) < hero.pointsInTalent(Talent.SHARED_ENCHANTMENT)
                    && hero.buff(MagicImmune.class) == null
                    && bow2 != null
                ...
                return Revolver.this.proc(attacker, defender, damage);
            }
        }
        ...
        public float delayFactor(Char user) {
            if (hero.buff(Riot.riotTracker.class) != null) {
                return Revolver.this.delayFactor(user)/2f;
            } else {
                return Revolver.this.delayFactor(user);
            }
        }
        ...
        @Override
        public int STRReq(int lvl) {
            if (Revolver.this.masteryPotionBonus) {
                return STRReq(tier, Revolver.this.buffedLvl()) - 2;
            }
            return STRReq(tier, Revolver.this.buffedLvl());
        }
