...
public class SubMachinegunHP extends MeleeWeapon {
    ...
    public String info() {
        ...
        if (levelKnown) {
            ...
            info += "\n\n" + Messages.get(SubMachinegunHP.class, "stats_known",
                    Bulletmin(SubMachinegunHP.this.buffedLvl()),
                    Bulletmax(SubMachinegunHP.this.buffedLvl()),
            ...
            info += "\n\n" + Messages.get(SubMachinegunHP.class, "stats_unknown",
                    Bulletmin(0),
                    Bulletmax(0),
                    round, max_round, new DecimalFormat("#.##").format(reload_time));
        }
    ...
    public SubMachinegunHP.Bullet knockBullet(){
        return new SubMachinegunHP.Bullet();
    }
    public class Bullet extends MissileWeapon {
        ...
        public int buffedLvl(){
            return SubMachinegunHP.this.buffedLvl();
        }
        ...
        public int damageRoll(Char owner) {
            ...
            int bulletdamage = Random.NormalIntRange(Bulletmin(SubMachinegunHP.this.buffedLvl()),
                    Bulletmax(SubMachinegunHP.this.buffedLvl()));
        ...
        public boolean hasEnchant(Class<? extends Enchantment> type, Char owner) {
            return SubMachinegunHP.this.hasEnchant(type, owner);
        }
        ...
        public int proc(Char attacker, Char defender, int damage) {
            ...
            if (SubMachinegunHP.this.enchantment == null
            ...
            } else if (SubMachinegunHP.this.enchantment == null
                    && Random.Int(3) < hero.pointsInTalent(Talent.SHARED_ENCHANTMENT)
                    && hero.buff(MagicImmune.class) == null
                    && bow2 != null
                ...
                return SubMachinegunHP.this.proc(attacker, defender, damage);
            }
        }
        ...
        public float delayFactor(Char user) {
            if (hero.buff(Riot.riotTracker.class) != null) {
                return SubMachinegunHP.this.delayFactor(user)/2f;
            } else {
                return SubMachinegunHP.this.delayFactor(user);
            }
        }
        ...
        @Override
        public int STRReq(int lvl) {
            return SubMachinegunHP.this.STRReq();
        }
