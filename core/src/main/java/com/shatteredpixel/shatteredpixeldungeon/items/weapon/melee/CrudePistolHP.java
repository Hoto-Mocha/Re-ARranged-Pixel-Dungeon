...
public class CrudePistolHP extends MeleeWeapon {
    ...
    public class Bullet extends MissileWeapon {
            ...
            if (hero.hasTalent(Talent.RECOIL_CONTROL)) {
                ...
                if (hero.buff(Riot.riotTracker.class) != null) {
                    ...
                    if (hero.hasTalent(Talent.HOLSTER) && round == max_round) {
                        return CrudePistolHP.this.delayFactor(user)/(1f+hero.pointsInTalent(Talent.HOLSTER));
                    } else
        ...
        @Override
        public int STRReq(int lvl) {
            if (CrudePistolHP.this.masteryPotionBonus) {
                return STRReq(tier, CrudePistolHP.this.buffedLvl()) - 2;
            }
            return STRReq(tier, CrudePistolHP.this.buffedLvl());
        }
    ...
    public static class Recipe extends com.shatteredpixel.shatteredpixeldungeon.items.Recipe.SimpleRecipe {
        ...
        {
            inputs =  new Class[]{CrudePistol.class, HPBullet.class, ArcaneResin.class};
            inQuantity = new int[]{1, 1, 1};

            cost = 0;

            output = CrudePistolHP.class;
            outQuantity = 1;
        }
