...
public class WA2000 extends MeleeWeapon {
    ...
    public void execute(Hero hero, String action) {
        ...
        if (action.equals(AC_SHOOT)) {
            ...
            if (!isEquipped( hero )) {
                ...
                if (round <= 0) {
                    reload_time = (hero.subClass == HeroSubClass.RIFLEMAN && hero.buff(Invisibility.class) != null) ? (1f + hero.pointsInTalent(Talent.ONLY_ONE_SHOT)) * RingOfReload.reloadMultiplier(Dungeon.hero)/2f : (1f + hero.pointsInTalent(Talent.ONLY_ONE_SHOT)) * RingOfReload.reloadMultiplier(Dungeon.hero);
                    reload();
                } else {
                    reload_time = (hero.subClass == HeroSubClass.RIFLEMAN && hero.buff(Invisibility.class) != null) ? (1f + hero.pointsInTalent(Talent.ONLY_ONE_SHOT)) * RingOfReload.reloadMultiplier(Dungeon.hero)/2f : (1f + hero.pointsInTalent(Talent.ONLY_ONE_SHOT)) * RingOfReload.reloadMultiplier(Dungeon.hero);
                    usesTargeting = true;
    ...
    public String info() {
        ...
        if (levelKnown) {
            ...
            info += "\n\n" + Messages.get(WA2000.class, "stats_known",
                    Bulletmin(WA2000.this.buffedLvl()),
                    Bulletmax(WA2000.this.buffedLvl()),
            ...
            info += "\n\n" + Messages.get(WA2000.class, "stats_unknown",
                    Bulletmin(0),
                    Bulletmax(0),
                    round, max_round, new DecimalFormat("#.##").format(reload_time));
        }
    ...
    public WA2000.Bullet knockBullet(){
        return new WA2000.Bullet();
    }
    public class Bullet extends MissileWeapon {
        ...
        public int damageRoll(Char owner) {
            ...
            int bulletdamage = Random.NormalIntRange(Bulletmin(WA2000.this.buffedLvl()),
                    Bulletmax(WA2000.this.buffedLvl()));
        ...
        public boolean hasEnchant(Class<? extends Enchantment> type, Char owner) {
            return WA2000.this.hasEnchant(type, owner);
        }
        ...
        public int proc(Char attacker, Char defender, int damage) {
            ...
            if (WA2000.this.enchantment == null
            ...
            } else if (WA2000.this.enchantment == null
                    && Random.Int(3) < hero.pointsInTalent(Talent.SHARED_ENCHANTMENT)
                    && hero.buff(MagicImmune.class) == null
                    && bow2 != null
                ...
                return WA2000.this.proc(attacker, defender, damage);
            }
        }
        ...
        public float delayFactor(Char user) {
            if (hero.buff(Riot.riotTracker.class) != null) {
                return WA2000.this.delayFactor(user)/2f;
            } else {
                return WA2000.this.delayFactor(user);
            }
        }
