...
public class CarbineHP extends MeleeWeapon {
    ...
    public String info() {
        ...
        if (levelKnown) {
            ...
            info += "\n\n" + Messages.get(CarbineHP.class, "stats_known",
                    Bulletmin(CarbineHP.this.buffedLvl()),
                    Bulletmax(CarbineHP.this.buffedLvl()),
            ...
            info += "\n\n" + Messages.get(CarbineHP.class, "stats_unknown",
                    Bulletmin(0),
                    Bulletmax(0),
                    round, max_round, new DecimalFormat("#.##").format(reload_time));
        }
    ...
    public CarbineHP.Bullet knockBullet(){
        return new CarbineHP.Bullet();
    }
    public class Bullet extends MissileWeapon {
        ...
        public int buffedLvl(){
            return CarbineHP.this.buffedLvl();
        }
        ...
        public int damageRoll(Char owner) {
            ...
            int bulletdamage = Random.NormalIntRange(Bulletmin(CarbineHP.this.buffedLvl()),
                    Bulletmax(CarbineHP.this.buffedLvl()));
        ...
        public boolean hasEnchant(Class<? extends Enchantment> type, Char owner) {
            return CarbineHP.this.hasEnchant(type, owner);
        }
        ...
        public int proc(Char attacker, Char defender, int damage) {
            ...
            if (CarbineHP.this.enchantment == null
            ...
            } else if (CarbineHP.this.enchantment == null
                    && Random.Int(3) < hero.pointsInTalent(Talent.SHARED_ENCHANTMENT)
                    && hero.buff(MagicImmune.class) == null
                    && bow2 != null
                ...
                return CarbineHP.this.proc(attacker, defender, damage);
            }
        }
        ...
        public float delayFactor(Char user) {
            if (hero.buff(Riot.riotTracker.class) != null) {
                return CarbineHP.this.delayFactor(user)/2f;
            } else {
                return CarbineHP.this.delayFactor(user);
            }
        }
        ...
        @Override
        public int STRReq(int lvl) {
            if (CarbineHP.this.masteryPotionBonus) {
                return STRReq(tier, CarbineHP.this.buffedLvl()) - 2;
            }
            return STRReq(tier, CarbineHP.this.buffedLvl());
        }
