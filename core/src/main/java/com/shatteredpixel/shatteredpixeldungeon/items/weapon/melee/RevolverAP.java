...
public class RevolverAP extends MeleeWeapon {
    ...
    public String info() {
        ...
        if (levelKnown) {
            ...
            info += "\n\n" + Messages.get(RevolverAP.class, "stats_known",
                    Bulletmin(RevolverAP.this.buffedLvl()),
                    Bulletmax(RevolverAP.this.buffedLvl()),
            ...
            info += "\n\n" + Messages.get(RevolverAP.class, "stats_unknown",
                    Bulletmin(0),
                    Bulletmax(0),
                    round, max_round, new DecimalFormat("#.##").format(reload_time));
        }
    ...
    public RevolverAP.Bullet knockBullet(){
        return new RevolverAP.Bullet();
    }
    public class Bullet extends MissileWeapon {
        ...
        public int buffedLvl(){
            return RevolverAP.this.buffedLvl();
        }
        ...
        public int damageRoll(Char owner) {
            ...
            int bulletdamage = Random.NormalIntRange(Bulletmin(RevolverAP.this.buffedLvl()),
                    Bulletmax(RevolverAP.this.buffedLvl()));
        ...
        public boolean hasEnchant(Class<? extends Enchantment> type, Char owner) {
            return RevolverAP.this.hasEnchant(type, owner);
        }
        ...
        public int proc(Char attacker, Char defender, int damage) {
            ...
            if (RevolverAP.this.enchantment == null
            ...
            } else if (RevolverAP.this.enchantment == null
                    && Random.Int(3) < hero.pointsInTalent(Talent.SHARED_ENCHANTMENT)
                    && hero.buff(MagicImmune.class) == null
                    && bow2 != null
                ...
                return RevolverAP.this.proc(attacker, defender, damage);
            }
        }
        ...
        public float delayFactor(Char user) {
            if (hero.buff(Riot.riotTracker.class) != null) {
                return RevolverAP.this.delayFactor(user)/2f;
            } else {
                return RevolverAP.this.delayFactor(user);
            }
        }
