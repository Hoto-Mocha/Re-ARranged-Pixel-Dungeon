...
public class WA2000AP extends MeleeWeapon {
    ...
    public String info() {
        ...
        if (levelKnown) {
            ...
            info += "\n\n" + Messages.get(WA2000AP.class, "stats_known",
                    Bulletmin(WA2000AP.this.buffedLvl()),
                    Bulletmax(WA2000AP.this.buffedLvl()),
            ...
            info += "\n\n" + Messages.get(WA2000AP.class, "stats_unknown",
                    Bulletmin(0),
                    Bulletmax(0),
                    round, max_round, new DecimalFormat("#.##").format(reload_time));
        }
    ...
    public WA2000AP.Bullet knockBullet(){
        return new WA2000AP.Bullet();
    }
    public class Bullet extends MissileWeapon {
        ...
        public int buffedLvl(){
            return WA2000AP.this.buffedLvl();
        }
        ...
        public int damageRoll(Char owner) {
            ...
            int bulletdamage = Random.NormalIntRange(Bulletmin(WA2000AP.this.buffedLvl()),
                    Bulletmax(WA2000AP.this.buffedLvl()));
        ...
        public boolean hasEnchant(Class<? extends Enchantment> type, Char owner) {
            return WA2000AP.this.hasEnchant(type, owner);
        }
        ...
        public int proc(Char attacker, Char defender, int damage) {
            ...
            if (WA2000AP.this.enchantment == null
            ...
            } else if (WA2000AP.this.enchantment == null
                    && Random.Int(3) < hero.pointsInTalent(Talent.SHARED_ENCHANTMENT)
                    && hero.buff(MagicImmune.class) == null
                    && bow2 != null
                ...
                return WA2000AP.this.proc(attacker, defender, damage);
            }
        }
        ...
        public float delayFactor(Char user) {
            if (hero.buff(Riot.riotTracker.class) != null) {
                return WA2000AP.this.delayFactor(user)/2f;
            } else {
