...
public class AssultRifleHP extends MeleeWeapon {
    ...
    public String info() {
        ...
        if (levelKnown) {
            ...
            info += "\n\n" + Messages.get(AssultRifleHP.class, "stats_known",
                    Bulletmin(AssultRifleHP.this.buffedLvl()),
                    Bulletmax(AssultRifleHP.this.buffedLvl()),
            ...
            info += "\n\n" + Messages.get(AssultRifleHP.class, "stats_unknown",
                    Bulletmin(0),
                    Bulletmax(0),
                    round, max_round, new DecimalFormat("#.##").format(reload_time));
        }
    ...
    public AssultRifleHP.Bullet knockBullet(){
        return new AssultRifleHP.Bullet();
    }
    public class Bullet extends MissileWeapon {
        ...
        public int buffedLvl(){
            return AssultRifleHP.this.buffedLvl();
        }
        ...
        public int damageRoll(Char owner) {
            ...
            int bulletdamage = Random.NormalIntRange(Bulletmin(AssultRifleHP.this.buffedLvl()),
                    Bulletmax(AssultRifleHP.this.buffedLvl()));
        ...
        public boolean hasEnchant(Class<? extends Enchantment> type, Char owner) {
            return AssultRifleHP.this.hasEnchant(type, owner);
        }
        ...
        public int proc(Char attacker, Char defender, int damage) {
            ...
            if (AssultRifleHP.this.enchantment == null
            ...
            } else if (AssultRifleHP.this.enchantment == null
                    && Random.Int(3) < hero.pointsInTalent(Talent.SHARED_ENCHANTMENT)
                    && hero.buff(MagicImmune.class) == null
                    && bow2 != null
                ...
                return AssultRifleHP.this.proc(attacker, defender, damage);
            }
        }
        ...
        public float delayFactor(Char user) {
            if (hero.buff(Riot.riotTracker.class) != null) {
                return AssultRifleHP.this.delayFactor(user)/2f;
            } else {
                return AssultRifleHP.this.delayFactor(user);
            }
        }
        ...
        @Override
        public int STRReq(int lvl) {
            if (AssultRifleHP.this.masteryPotionBonus) {
                return STRReq(tier, AssultRifleHP.this.buffedLvl()) - 2;
            }
            return STRReq(tier, AssultRifleHP.this.buffedLvl());
        }
