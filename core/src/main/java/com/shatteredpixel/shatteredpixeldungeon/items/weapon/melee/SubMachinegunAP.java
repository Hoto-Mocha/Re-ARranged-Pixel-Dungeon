...
public class SubMachinegunAP extends MeleeWeapon {
    ...
    public String info() {
        ...
        if (levelKnown) {
            ...
            info += "\n\n" + Messages.get(SubMachinegunAP.class, "stats_known",
                    Bulletmin(SubMachinegunAP.this.buffedLvl()),
                    Bulletmax(SubMachinegunAP.this.buffedLvl()),
            ...
            info += "\n\n" + Messages.get(SubMachinegunAP.class, "stats_unknown",
                    Bulletmin(0),
                    Bulletmax(0),
                    round, max_round, new DecimalFormat("#.##").format(reload_time));
        }
    ...
    public SubMachinegunAP.Bullet knockBullet(){
        return new SubMachinegunAP.Bullet();
    }
    public class Bullet extends MissileWeapon {
        ...
        public int buffedLvl(){
            return SubMachinegunAP.this.buffedLvl();
        }
        ...
        public int damageRoll(Char owner) {
            ...
            int bulletdamage = Random.NormalIntRange(Bulletmin(SubMachinegunAP.this.buffedLvl()),
                    Bulletmax(SubMachinegunAP.this.buffedLvl()));
        ...
        public boolean hasEnchant(Class<? extends Enchantment> type, Char owner) {
            return SubMachinegunAP.this.hasEnchant(type, owner);
        }
        ...
        public int proc(Char attacker, Char defender, int damage) {
            ...
            if (SubMachinegunAP.this.enchantment == null
            ...
            } else if (SubMachinegunAP.this.enchantment == null
                    && Random.Int(3) < hero.pointsInTalent(Talent.SHARED_ENCHANTMENT)
                    && hero.buff(MagicImmune.class) == null
                    && bow2 != null
                ...
                return SubMachinegunAP.this.proc(attacker, defender, damage);
            }
        }
        ...
        public float delayFactor(Char user) {
            if (hero.buff(Riot.riotTracker.class) != null) {
                return SubMachinegunAP.this.delayFactor(user)/2f;
            } else {
                return SubMachinegunAP.this.delayFactor(user);
            }
        }
        ...
        @Override
        public int STRReq(int lvl) {
            if (SubMachinegunAP.this.masteryPotionBonus) {
                return STRReq(tier, SubMachinegunAP.this.buffedLvl()) - 2;
            }
            return STRReq(tier, SubMachinegunAP.this.buffedLvl());
        }
