...
public class GrenadeLauncherAP extends MeleeWeapon {
        ...
        if (action.equals(AC_SHOOT)) {
            if (round <= 0) {
                ...
                if (hero.buff(GrenadeCoolDown.class) != null) {
                    usesTargeting = false;
                    GLog.w(Messages.get(GrenadeLauncherAP.class, "cannot_reload"));
                } else {
                    reload();
                }
            } else {
    ...
    public class Rocket extends MissileWeapon {
        ...
        @Override
        public int buffedLvl(){
            return GrenadeLauncherAP.this.buffedLvl();
        }
        ...
        public int proc(Char attacker, Char defender, int damage) {
            ...
            if (GrenadeLauncherAP.this.enchantment == null
            ...
            } else if (GrenadeLauncherAP.this.enchantment == null
                    && Random.Int(3) < hero.pointsInTalent(Talent.SHARED_ENCHANTMENT)
                    && hero.buff(MagicImmune.class) == null
                    && bow2 != null
        ...
        protected void onThrow(int cell) {
            Buff.prolong(hero, GrenadeCoolDown.class, 30f);
