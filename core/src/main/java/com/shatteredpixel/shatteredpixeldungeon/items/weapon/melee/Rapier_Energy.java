...
public class Rapier_Energy extends EnergyWeapon {
				...
				if (enemy != null) {
					hero.sprite.attack(enemy.pos, new Callback() {
						...
						public void call() {
							...
							if (hero.attack(enemy, 1.67f, 0, Char.INFINITE_ACCURACY)) {
	...
	public static class Recipe extends com.shatteredpixel.shatteredpixeldungeon.items.Recipe.SimpleRecipe {
		...
		{
			inputs = new Class[]{Rapier.class, ScrollOfUpgrade.class, LiquidMetal.class};
			inQuantity = new int[]{1, 1, 10};

			cost = 8;

			output = Rapier_Energy.class;
			outQuantity = 1;
		}
	}
}
