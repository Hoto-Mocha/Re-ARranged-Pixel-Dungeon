...
public class SniperRifleHP extends MeleeWeapon {
    ...
    public String info() {
        ...
        if (levelKnown) {
            ...
            info += "\n\n" + Messages.get(SniperRifleHP.class, "stats_known",
                    Bulletmin(SniperRifleHP.this.buffedLvl()),
                    Bulletmax(SniperRifleHP.this.buffedLvl()),
            ...
            info += "\n\n" + Messages.get(SniperRifleHP.class, "stats_unknown",
                    Bulletmin(0),
                    Bulletmax(0),
                    round, max_round, new DecimalFormat("#.##").format(reload_time));
        }
    ...
    public SniperRifleHP.Bullet knockBullet(){
        return new SniperRifleHP.Bullet();
    }
    public class Bullet extends MissileWeapon {
        ...
        public int buffedLvl(){
            return SniperRifleHP.this.buffedLvl();
        }
        ...
        public int damageRoll(Char owner) {
            ...
            int bulletdamage = Random.NormalIntRange(Bulletmin(SniperRifleHP.this.buffedLvl()),
                    Bulletmax(SniperRifleHP.this.buffedLvl()));
        ...
        public boolean hasEnchant(Class<? extends Enchantment> type, Char owner) {
            return SniperRifleHP.this.hasEnchant(type, owner);
        }
        ...
        public int proc(Char attacker, Char defender, int damage) {
            ...
            if (SniperRifleHP.this.enchantment == null
            ...
            } else if (SniperRifleHP.this.enchantment == null
                    && Random.Int(3) < hero.pointsInTalent(Talent.SHARED_ENCHANTMENT)
                    && hero.buff(MagicImmune.class) == null
                    && bow2 != null
                ...
                return SniperRifleHP.this.proc(attacker, defender, damage);
            }
        }
        ...
        @Override
        public int STRReq(int lvl) {
            if (SniperRifleHP.this.masteryPotionBonus) {
                return STRReq(tier, SniperRifleHP.this.buffedLvl()) - 2;
            }
            return STRReq(tier, SniperRifleHP.this.buffedLvl());
        }
