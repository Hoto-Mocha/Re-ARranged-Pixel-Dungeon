...
public class GoldenBow extends Weapon {
	
	public static final String AC_SHOOT		= "SHOOT";
	// 데미지 1.2배, 공격 명중률 1.1배
	...
	public String info() {
		...
		info += "\n\n" + Messages.get( GoldenBow.class, "stats",
	...
	public class SpiritArrow extends MissileWeapon {
		...
		@Override
		public int damageRoll(Char owner) {
			return GoldenBow.this.damageRoll(owner);
		}
		
		@Override
		public boolean hasEnchant(Class<? extends Enchantment> type, Char owner) {
			return GoldenBow.this.hasEnchant(type, owner);
		}
		
		@Override
		public int proc(Char attacker, Char defender, int damage) {
			return GoldenBow.this.proc(attacker, defender, damage);
		}
		
		@Override
		public float delayFactor(Char user) {
			return GoldenBow.this.delayFactor(user);
		}
		...
		@Override
		public int STRReq(int lvl) {
			return GoldenBow.this.STRReq(lvl);
		}
		...
		public void cast(final Hero user, final int dst) {
			...
			GoldenBow.this.targetPos = cell;
			if (sniperSpecial && GoldenBow.this.augment == Augment.SPEED){
	...
	private CellSelector.Listener shooter = new CellSelector.Listener() {
		...
		public String prompt() {
			return Messages.get(GoldenBow.class, "prompt");
		}
	};
}
