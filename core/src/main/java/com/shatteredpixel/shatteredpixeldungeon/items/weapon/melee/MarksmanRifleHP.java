...
public class MarksmanRifleHP extends MeleeWeapon {
    ...
    public String info() {
        ...
        if (levelKnown) {
            ...
            info += "\n\n" + Messages.get(MarksmanRifleHP.class, "stats_known",
                    Bulletmin(MarksmanRifleHP.this.buffedLvl()),
                    Bulletmax(MarksmanRifleHP.this.buffedLvl()),
            ...
            info += "\n\n" + Messages.get(MarksmanRifleHP.class, "stats_unknown",
                    Bulletmin(0),
                    Bulletmax(0),
                    round, max_round, new DecimalFormat("#.##").format(reload_time));
        }
    ...
    public MarksmanRifleHP.Bullet knockBullet(){
        return new MarksmanRifleHP.Bullet();
    }
    public class Bullet extends MissileWeapon {
        ...
        public int buffedLvl(){
            return MarksmanRifleHP.this.buffedLvl();
        }
        ...
        public int damageRoll(Char owner) {
            ...
            int bulletdamage = Random.NormalIntRange(Bulletmin(MarksmanRifleHP.this.buffedLvl()),
                    Bulletmax(MarksmanRifleHP.this.buffedLvl()));
        ...
        public boolean hasEnchant(Class<? extends Enchantment> type, Char owner) {
            return MarksmanRifleHP.this.hasEnchant(type, owner);
        }
        ...
        public int proc(Char attacker, Char defender, int damage) {
            ...
            if (MarksmanRifleHP.this.enchantment == null
            ...
            } else if (MarksmanRifleHP.this.enchantment == null
                    && Random.Int(3) < hero.pointsInTalent(Talent.SHARED_ENCHANTMENT)
                    && hero.buff(MagicImmune.class) == null
                    && bow2 != null
                ...
                return MarksmanRifleHP.this.proc(attacker, defender, damage);
            }
        }
        ...
        public float delayFactor(Char user) {
            if (hero.buff(Riot.riotTracker.class) != null) {
                return MarksmanRifleHP.this.delayFactor(user)/2f;
            } else {
                return MarksmanRifleHP.this.delayFactor(user);
            }
        }
