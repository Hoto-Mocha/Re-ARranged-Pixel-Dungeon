	...
	public static ArrayList<QuickRecipe> getRecipes( int pageIdx ){
		...
		switch (pageIdx){
			...
			case 6:
				...
				result.add(null);
				result.add(new QuickRecipe(new PistolAP.Recipe()));
				result.add(new QuickRecipe(new PistolHP.Recipe()));
				result.add(null);
				result.add(new QuickRecipe(new GoldenPistolAP.Recipe()));
				result.add(new QuickRecipe(new GoldenPistolHP.Recipe()));
				result.add(null);
				result.add(new QuickRecipe(new HandgunAP.Recipe()));
				result.add(new QuickRecipe(new HandgunHP.Recipe()));
				result.add(null);
				result.add(new QuickRecipe(new MagnumAP.Recipe()));
				result.add(new QuickRecipe(new MagnumHP.Recipe()));
				result.add(null);
				result.add(new QuickRecipe(new DualPistolAP.Recipe()));
				result.add(new QuickRecipe(new DualPistolHP.Recipe()));
				result.add(null);
				result.add(new QuickRecipe(new SubMachinegunAP.Recipe()));
				result.add(new QuickRecipe(new SubMachinegunHP.Recipe()));
				result.add(null);
				result.add(new QuickRecipe(new AssultRifleAP.Recipe()));
				result.add(new QuickRecipe(new AssultRifleHP.Recipe()));
				result.add(null);
				result.add(new QuickRecipe(new HeavyMachinegunAP.Recipe()));
				result.add(new QuickRecipe(new HeavyMachinegunHP.Recipe()));
				result.add(null);
				result.add(new QuickRecipe(new HuntingRifleAP.Recipe()));
				result.add(new QuickRecipe(new HuntingRifleHP.Recipe()));
				result.add(null);
				result.add(new QuickRecipe(new SniperRifleAP.Recipe()));
				result.add(new QuickRecipe(new SniperRifleHP.Recipe()));
				result.add(null);
				result.add(new QuickRecipe(new ShotGunAP.Recipe()));
				result.add(new QuickRecipe(new ShotGunHP.Recipe()));
				result.add(null);
				result.add(new QuickRecipe(new LargeHandgunAP.Recipe()));
				result.add(new QuickRecipe(new LargeHandgunHP.Recipe()));
				result.add(null);
				result.add(new QuickRecipe(new AntimaterRifleAP.Recipe()));
				result.add(new QuickRecipe(new AntimaterRifleHP.Recipe()));
				result.add(null);
				result.add(new QuickRecipe(new MiniGunAP.Recipe()));
				result.add(new QuickRecipe(new MiniGunHP.Recipe()));
				result.add(null);
				result.add(new QuickRecipe(new SPASAP.Recipe()));
				result.add(new QuickRecipe(new SPASHP.Recipe()));
				result.add(null);
