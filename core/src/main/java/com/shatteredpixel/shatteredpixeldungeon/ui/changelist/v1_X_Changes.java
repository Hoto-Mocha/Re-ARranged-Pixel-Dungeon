...
public class v1_X_Changes {
	...
	public static void add_v2_26_Changes( ArrayList<ChangeInfo> changeInfos ) {
		ChangeInfo changes = new ChangeInfo("ARranged v2.26", true, "");
		...
		changes.addButton(new ChangeButton(new ItemSprite(ItemSpriteSheet.LARGEHANDGUN), "Added Guns",
				"_The Guns Are Added in ARPD!_\n\n" +
						...
						"- _Sniper Rifles:_ High Damage, but Long Reload Time.\n" +
		...
		changes.addButton( new ChangeButton(new Image(Assets.Sprites.KNIGHT, 0, 90, 12, 15), HeroClass.KNIGHT.title(),
				"- _Knight: Specialist of Defense_\n\n" +
						"- Most of the Knight's abilities are focused on defense.\n" +
		...
		changes.addButton( new ChangeButton(new Image(Assets.Sprites.NURSE, 0, 90, 12, 15), HeroClass.NURSE.title(),
				"- _Nurse: Specialist of Supporting_\n\n" +
						"- Most of the _Nurse's abilities are focused on supporting allies.\n" +
						"- Nurse's Hand Mirror and Gamma Ray Gun is the Nurse's unique item, which grants hero make and heal allies.\n" +
						"- Subclasses have unique abilities each, and all of them is powerful.\n" +
						"- _5th_ of New Classes of ARPD\n" +
						"- You can play Nurse _after you clear the game once._"));
		...
		changes.addButton(new ChangeButton(Icons.get(Icons.CHALLENGE_ON), "New Challenges",
				"_3 of brand new Challenges are Added in ARPD!_\n\n" +
						...
						"- _Cursed Dungeon:_ Many of enemies have a chance of summon hostile wraith after they die, and hostile wraiths are continuously appear around you.\n" +
						"- _Durability:_ This activates the durability system, preventing your equipment from operating indefinitely. Yes, the original Pixel Dungeon's that thing, as you think."));
