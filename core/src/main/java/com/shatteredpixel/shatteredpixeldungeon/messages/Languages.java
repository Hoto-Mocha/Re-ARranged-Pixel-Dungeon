...
public enum Languages {
	...
	CHINESE("中文",          "zh", Status.REVIEWED,   new String[]{"Beyond121", "Jinkeloid(zdx00793)", "endlesssolitude"}, new String[]{"Beyond121", "931451545", "Chronie_Lynn_Iwa", "Fatir", "Fishbone", "Hcat", "HoofBumpBlurryface", "Lery", "Lyn_0401", "Ooooscar", "ShatteredFlameBlast", "SpaceAnchor", "hmdzl001", "leo", "tempest102"}),
