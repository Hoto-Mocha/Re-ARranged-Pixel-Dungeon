...
public enum Languages {
	...
	RUSSIAN("русский",      "ru", 	Status.X_UNFINISH, new String[]{"Dominowood371", "Alexandr Klimov", "Abama Abama", "Aleksey Petrenko"}, new String[]{""}),
	CHI_SMPL("简体中文",     "zh", 	Status.X_UNFINISH, new String[]{"Bindweed", "Eygy6556", "fadedwater", "nupnuts", "wangsenxing"}, new String[]{""}),
