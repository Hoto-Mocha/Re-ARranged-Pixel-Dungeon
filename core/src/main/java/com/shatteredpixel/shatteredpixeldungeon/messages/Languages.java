...
public enum Languages {
	...
	RUSSIAN("русский",      "ru", 	Status.__UNREVIEW, new String[]{""}, new String[]{"Dominowood371", "Alexandr Klimov", "Abama Abama", "Aleksey Petrenko"}),
	ENGLISH("english",      "",   	Status.__UNREVIEW, new String[]{"Cocoa(Hoto-Mocha)"}, new String[]{"Cocoa(Hoto-Mocha)", "ChatGPT", "CykoRex"}),
	CHI_SMPL("简体中文",     "zh", 	Status.X_UNFINISH, new String[]{"Chronie_Lynn_Iwa", "Jinkeloid(zdx00793)", "endlesssolitude"}, new String[]{"931451545", "Budding", "Fatir", "Fishbone", "Hcat", "HoofBumpBlurryface", "Horr_lski", "Lery", "Lyn_0401", "Lyx0527", "Ooooscar", "RainSlide", "ShatteredFlameBlast", "SpaceAnchor", "SunsetGlowTheDOGE", "Teller", "hmdzl001", "leo", "tempest102", "户方狸奴"}),
