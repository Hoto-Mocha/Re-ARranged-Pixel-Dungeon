...
public class PathFinder {
	...
	public static void setMapSize( int width, int height ) {
		...
		NEIGHBOURS48 = new int[]{-3*width-3, -3*width-2, -3*width-1, -3*width, -3*width+1, -3*width+2, -3*width+3, -2*width-3, -2*width-2, -2*width-1, -2*width, -2*width+1, -2*width+2, -2*width+3, -width-3, -width-2, -width-1, -width, -width+1, -width+2, -width+3, -3, -2, -1, 0, +1, +2, +3, +width-3, +width-2, +width-1, +width, +width+1, +width+2, +width+3, +2*width-3, +2*width-2, +2*width-1, +2*width, +2*width+1, +2*width+2, +2*width+3, +3*width-3, +3*width-2, +3*width-1, +3*width, +3*width+1, +3*width+2, +3*width+3};
